        ...
        <div className="container mx-auto px-4 lg:px-8 max-w-4xl">
          ...
          <div className="prose prose-sm max-w-none text-foreground">
            <section className="mb-6">
              <h2 className="text-base font-heading font-semibold text-foreground mb-2">1. Acceptance of Terms</h2>
            ...
            <section className="mb-6">
              <h2 className="text-base font-heading font-semibold text-foreground mb-2">2. Description of Services</h2>
              <p className="text-xs text-muted-foreground leading-relaxed">
            ...
            <section className="mb-6">
              <h2 className="text-base font-heading font-semibold text-foreground mb-2">3. User Responsibilities</h2>
              <p className="text-xs text-muted-foreground leading-relaxed mb-2">When using our services, you agree to:</p>
            ...
            <section className="mb-6">
              <h2 className="text-base font-heading font-semibold text-foreground mb-2">4. Resume and Data Submission</h2>
              <p className="text-xs text-muted-foreground leading-relaxed">
            ...
            <section className="mb-6">
              <h2 className="text-base font-heading font-semibold text-foreground mb-2">5. Cookies and Tracking</h2>
            ...
            <section className="mb-6">
              <h2 className="text-base font-heading font-semibold text-foreground mb-2">6. Intellectual Property</h2>
              <p className="text-xs text-muted-foreground leading-relaxed">
            ...
            <section className="mb-6">
              <h2 className="text-base font-heading font-semibold text-foreground mb-2">7. Limitation of Liability</h2>
              <p className="text-xs text-muted-foreground leading-relaxed">
            ...
            <section className="mb-6">
              <h2 className="text-base font-heading font-semibold text-foreground mb-2">8. Modifications to Terms</h2>
              <p className="text-xs text-muted-foreground leading-relaxed">
            ...
            <section className="mb-6">
              <h2 className="text-base font-heading font-semibold text-foreground mb-2">9. Governing Law</h2>
              <p className="text-xs text-muted-foreground leading-relaxed">
            ...
            <section className="mb-6">
              <h2 className="text-base font-heading font-semibold text-foreground mb-2">10. Contact Information</h2>
              <p className="text-xs text-muted-foreground leading-relaxed mb-2">
