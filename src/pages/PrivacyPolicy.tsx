        ...
        <div className="container mx-auto px-4 lg:px-8 max-w-4xl">
          ...
          <div className="prose prose-sm max-w-none text-foreground">
            <section className="mb-6">
              <h2 className="text-base font-heading font-semibold text-foreground mb-2">1. Introduction</h2>
            ...
            <section className="mb-6">
              <h2 className="text-base font-heading font-semibold text-foreground mb-2">2. Information We Collect</h2>
              <p className="text-xs text-muted-foreground leading-relaxed mb-2">We may collect the following types of information:</p>
            ...
            <section className="mb-6">
              <h2 className="text-base font-heading font-semibold text-foreground mb-2">3. How We Use Your Information</h2>
              <p className="text-xs text-muted-foreground leading-relaxed mb-2">We use the information we collect to:</p>
              <ul className="list-disc pl-4 text-xs text-muted-foreground space-y-1">
            ...
            <section className="mb-6">
              <h2 className="text-base font-heading font-semibold text-foreground mb-2">4. Information Sharing</h2>
              <p className="text-xs text-muted-foreground leading-relaxed mb-2">We may share your information with:</p>
              <ul className="list-disc pl-4 text-xs text-muted-foreground space-y-1">
            ...
            <section className="mb-6">
              <h2 className="text-base font-heading font-semibold text-foreground mb-2">5. Data Security</h2>
              <p className="text-xs text-muted-foreground leading-relaxed">
            ...
            <section className="mb-6">
              <h2 className="text-base font-heading font-semibold text-foreground mb-2">6. Data Retention</h2>
              <p className="text-xs text-muted-foreground leading-relaxed">
            ...
            <section className="mb-6">
              <h2 className="text-base font-heading font-semibold text-foreground mb-2">7. Your Rights</h2>
              <p className="text-xs text-muted-foreground leading-relaxed mb-2">You have the right to:</p>
              <ul className="list-disc pl-4 text-xs text-muted-foreground space-y-1">
            ...
            <section className="mb-6">
              <h2 className="text-base font-heading font-semibold text-foreground mb-2">9. Contact Us</h2>
