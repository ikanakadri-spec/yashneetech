      ...
      <section id="services" className="py-10 bg-background/80 backdrop-blur-sm relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 lg:px-8 relative z-10">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {services.map((service, index) => <div key={service.title} className="group relative p-8 rounded-2xl bg-ivory border border-border/50 hover:border-champagne hover:bg-champagne/30 transition-all duration-500 hover:-translate-y-2 hover:shadow-2xl hover:shadow-champagne/40" style={{
            animationDelay: `${index * 100}ms`
          }}>
                {/* Gradient overlay on hover */}
                <div className="absolute inset-0 rounded-2xl bg-gradient-to-br from-champagne/20 via-gold/10 to-champagne/25 opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
                
                <div className="relative z-10">
                  <div className="w-16 h-16 bg-gradient-to-br from-emerald to-emerald-light rounded-2xl flex items-center justify-center mb-6 group-hover:scale-110 group-hover:shadow-lg group-hover:shadow-champagne/30 transition-all duration-500">
