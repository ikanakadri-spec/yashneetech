          ...
          <div className="space-y-4">
            <Link to="/" className="flex items-center gap-3 group transition-transform duration-300 hover:scale-105">
              ...
              <div className="flex flex-col">
                ...
                <span className="-mt-1 bg-gradient-to-r from-champagne via-cream to-champagne bg-[length:200%_auto] bg-clip-text text-transparent animate-text-shimmer text-[10px] md:text-xs tracking-wider italic font-semibold [text-shadow:0_1px_2px_hsl(var(--foreground)_/_0.35),0_0_18px_hsl(var(--champagne)_/_0.7),0_0_8px_hsl(var(--champagne)_/_0.5)]">
