        ...
        <div className="items-center justify-between h-20 lg:h-24 flex flex-row">
          <Link to="/" className="flex items-center group transition-transform duration-300 hover:scale-105">
            <AutoTransparentImage 
              ...
              className="h-20 md:h-28 lg:h-32 w-auto object-contain [filter:drop-shadow(0_0_14px_rgba(255,165,0,0.85))_drop-shadow(0_0_10px_rgba(144,238,144,0.75))_drop-shadow(0_0_6px_rgba(255,200,100,0.65))_drop-shadow(0_0_4px_rgba(100,255,100,0.55))_drop-shadow(0_2px_4px_rgba(0,0,0,0.3))]" 
              tolerance={90} 
            />
          </Link>
