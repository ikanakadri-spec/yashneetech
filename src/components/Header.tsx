...
const Dropdown = ({
  ...
  return <div className="relative" ref={dropdownRef}>
      <button onClick={() => setIsOpen(!isOpen)} className="relative flex items-center gap-1 px-4 py-2 text-sm font-bold text-white hover:text-gold transition-all duration-300 drop-shadow-[0_1px_2px_rgba(0,0,0,0.8)] after:absolute after:bottom-0 after:left-0 after:h-0.5 after:w-0 after:bg-gold after:transition-all after:duration-300 hover:after:w-full" style={{ textShadow: '0 0 3px rgba(255,255,255,0.3), 0 1px 2px rgba(0,0,0,0.8)' }}>
        {label}
      ...
      <div className="container mx-auto px-4 lg:px-8">
        <div className="flex items-center justify-between h-16 lg:h-20">
          ...
          <nav className="hidden lg:flex items-center">
            ...
            <ExpertiseDropdown />
            <Link to="/#who-we-are" className="relative px-4 py-2 text-sm font-bold text-white hover:text-gold transition-all duration-300 drop-shadow-[0_1px_2px_rgba(0,0,0,0.8)] after:absolute after:bottom-0 after:left-0 after:h-0.5 after:w-0 after:bg-gold after:transition-all after:duration-300 hover:after:w-full" style={{ textShadow: '0 0 3px rgba(255,255,255,0.3), 0 1px 2px rgba(0,0,0,0.8)' }}>
              Who We Are
            </Link>
