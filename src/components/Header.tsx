...
const Dropdown = ({
  ...
  return <div className="relative" ref={dropdownRef}>
      <button onClick={() => setIsOpen(!isOpen)} className="flex items-center gap-1 px-4 py-2.5 text-sm font-bold bg-emerald text-white rounded-md hover:bg-emerald-light transition-colors">
        {label}
      ...
      <div className="container mx-auto px-4 lg:px-8">
        <div className="flex items-center justify-between h-16 lg:h-20">
          ...
          <nav className="hidden lg:flex items-center">
            ...
            <ExpertiseDropdown />
            <Link to="/#who-we-are" className="px-4 py-2.5 text-sm font-bold bg-emerald text-white rounded-md hover:bg-emerald-light transition-colors">
              Who We Are
            </Link>
