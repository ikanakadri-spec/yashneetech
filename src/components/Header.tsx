        ...
        <div className="items-center justify-between h-20 lg:h-24 flex flex-row">
          <Link to="/" className="flex items-center gap-3 group transition-transform duration-300 hover:scale-105 -ml-4 lg:-ml-6">
            ...
            <div className="flex flex-col">
              <span className="text-white font-bold text-base md:text-lg lg:text-xl tracking-tight">
                YASHNEE TECH
              </span>
              <span className="text-orange-500 font-extrabold text-sm md:text-base lg:text-lg uppercase tracking-wide">
