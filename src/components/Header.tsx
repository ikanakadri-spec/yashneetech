    ...
    <header className={`fixed top-0 left-0 right-0 z-[60] transition-all duration-300 ${scrolled ? "bg-emerald-dark/80 backdrop-blur-md border-b border-emerald/20 shadow-lg" : "bg-transparent"}`}>
      <div className="container mx-auto px-4 lg:px-8">
        <div className="items-center justify-between h-20 lg:h-24 flex flex-row">
          <Link 
            to="/get-started" 
            className="flex items-center group transition-all duration-300 hover:scale-105 px-6 py-3 bg-emerald hover:bg-emerald-dark border-2 border-white/30 hover:border-white rounded-lg shadow-lg hover:shadow-glow"
          >
            <AutoTransparentImage 
              src={yashneeLogo} 
              alt="Yashnee - Next Gen Talent Partner" 
              className="h-12 md:h-14 lg:h-16 w-auto object-contain brightness-0 invert drop-shadow-[0_0_10px_rgba(255,255,255,0.5)]" 
              tolerance={90} 
            />
          </Link>
