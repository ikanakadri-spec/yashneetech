        ...
        <div className="items-center justify-between h-20 lg:h-24 flex flex-row">
          <Link to="/" className="flex flex-col items-start group transition-transform duration-300 hover:scale-105 -ml-4 lg:-ml-6">
            <AutoTransparentImage 
              src={yashneeLogo} 
              alt="Yashnee Tech" 
              className="h-16 md:h-20 lg:h-24 w-auto object-contain [clip-path:inset(0_0_25%_0)] [filter:drop-shadow(0_0_12px_rgba(255,255,255,0.9))_drop-shadow(0_0_6px_rgba(255,255,255,0.8))_drop-shadow(0_0_3px_rgba(255,255,255,1))_drop-shadow(0_2px_4px_rgba(0,0,0,0.3))]" 
              tolerance={90} 
            />
            <span className="-mt-4 md:-mt-5 lg:-mt-6 ml-1 text-[10px] md:text-xs lg:text-sm font-bold text-emerald tracking-wide [text-shadow:0_0_10px_rgba(16,185,129,0.6)]">
