        ...
        <div className="items-center justify-between h-20 lg:h-24 flex flex-row">
          <Link to="/" className="flex items-center group transition-transform duration-300 hover:scale-105 -ml-4 lg:-ml-6">
            <AutoTransparentImage 
              ...
              className="h-20 md:h-28 lg:h-32 w-auto object-contain [filter:drop-shadow(0_0_8px_rgba(255,255,255,0.5))_drop-shadow(0_0_4px_rgba(255,255,255,0.4))_drop-shadow(0_2px_4px_rgba(0,0,0,0.3))]" 
              tolerance={90} 
            />
          </Link>
