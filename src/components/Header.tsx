        ...
        <div className="items-center justify-between h-20 lg:h-24 flex flex-row">
          <Link to="/" className="flex items-center group transition-transform duration-300 hover:scale-105">
            <AutoTransparentImage 
              ...
              className="h-20 md:h-28 lg:h-32 w-auto object-contain [filter:drop-shadow(0_0_16px_rgba(255,255,255,1))_drop-shadow(0_0_10px_rgba(255,255,255,0.95))_drop-shadow(0_0_5px_rgba(255,255,255,1))_drop-shadow(0_0_2px_rgba(255,255,255,1))_drop-shadow(0_2px_6px_rgba(0,0,0,0.4))]" 
              tolerance={90} 
            />
          </Link>
