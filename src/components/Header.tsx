...
export const Header = () => {
  ...
  return <header className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${scrolled ? 'bg-emerald-dark border-b border-emerald/20 shadow-lg' : 'bg-transparent'}`}>
